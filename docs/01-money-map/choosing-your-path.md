...
| Path | Best For | Time to First $ | Risk Level | Monthly Potential |
|------|----------|-----------------|------------|-------------------|
...
```
Do you need money in the next 2 weeks?
...
### Websites — Watch Out If You:
- Hate client communication
- Can't handle revision requests
- Expect $5k+ per project immediately

### Automations — Watch Out If You:
- Don't understand business workflows
- Can't explain tech to non-technical clients
...
Even if you want to build automations or SaaS eventually.

Why:
1. **Fastest feedback loop** — Ship in days, get paid in weeks
2. **Client skills transfer** — Learn to sell, communicate, deliver
3. **Low stakes practice** — Mistakes cost hours, not months
4. **Portfolio builder** — Real work to show future clients

Once you've delivered 3-5 websites:
...
Your path isn't permanent. Many builders follow this progression:
...
**Next**: [Offer Design](./offer-design.md) — Package your services for predictable income.
